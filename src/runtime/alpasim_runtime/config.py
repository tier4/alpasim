...
class UserSimulatorConfig:
    ...
    # have the requested scene cached, avoiding cold-load penalties.
    scene_affine_dispatch: bool = False
    ...
    # periodic refresh.  Only effective when scene_affine_dispatch is True.
